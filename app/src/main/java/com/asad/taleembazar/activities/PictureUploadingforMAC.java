...
public class PictureUploadingforMAC {
...
String email;
  ...
  Context cnt;
    ...
    String ServerUploadPath = "http://taleembazaar.com/imageupload.php";

    public PictureUploadingforMAC(Context ctx, String email, Bitmap bm)
    {
        this.email=email;
        this.bitmap=bm;
        this.cnt=ctx;
